...
package com.xpt.vuforia.VuforiaSamples.ui.SampleAppMenu;
...
public class SampleAppMenuGroup
{
        ...
        int width)
    {
        ...
        mLayout = (LinearLayout) inflater.inflate(
            R.layout.vuforia_sample_app_menu_group, null, false);
        ...
        dividerResource = R.layout.vuforia_sample_app_menu_group_divider;
    ...
    public View addRadioItem(String text, int command, boolean isSelected)
    {
        ...
        RadioButton newRadioButton = (RadioButton) inflater.inflate(
            R.layout.vuforia_sample_app_menu_group_radio_button, null, false);
